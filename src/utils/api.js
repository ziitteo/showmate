...
const api = axios.create({
  ...
  baseURL:
    process.env.NODE_ENV === 'production'
      ? '/.netlify/functions/api-proxy' // 배포 환경에서는 Netlify Functions로 프록시 (프록시 서버로 요청을 보냄)
      : '/api/openApi/restful', // 로컬 개발 환경에서는 직접 Kopis API 서버로 요청 (setupProxy.js 파일을 통해 프록시 설정됨)
